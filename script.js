...
document.getElementById("discord").onclick=async()=>{try{await navigator.clipboard.writeText("idrako__");}catch(e){};document.getElementById("discord").innerHTML="Discord<br><b>_</b> — Copiado";};
